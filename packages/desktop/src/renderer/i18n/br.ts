export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Mio Desktop",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Mio Desktop foi baixada. Você gostaria de instalá-la e reiniciar?",
