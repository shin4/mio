...
export type Event =
  ...
  | EventSessionDiff
  | EventSessionError
  | EventSessionCacheMeasured
  | EventSessionCachePrefixDrift
  | EventFileEdited
...
export type DictationError = {
  name: "BadRequest" | "ProviderNotConnected" | "UpstreamError"
  data: {
    message?: string
  }
}
...
export type EventSessionCacheMeasured = {
  id: string
  type: "session.cache.measured"
  properties: {
    sessionID: string
    turnId: string
    readTokens: number
...
export type EventSessionCachePrefixDrift = {
  id: string
  type: "session.cache.prefix.drift"
  properties: {
    sessionID: string
    storedHash: string
    computedHash: string
...
export type DictationTranscribeData = {
  body?: {
    audio: {
      dataUrl: string
      mime: string
...
export type DictationTranscribeErrors = {
  /**
   * DictationError | InvalidRequestError
   */
  400: DictationError | InvalidRequestError
}

export type DictationTranscribeError = DictationTranscribeErrors[keyof DictationTranscribeErrors]

export type DictationTranscribeResponses = {
  /**
...
export type DictationTranscribeResponse = DictationTranscribeResponses[keyof DictationTranscribeResponses]
...
export type TtsSynthesizeErrors = {
  /**
   * TtsError | InvalidRequestError
   */
  400: TtsError | InvalidRequestError
}

export type TtsSynthesizeError = TtsSynthesizeErrors[keyof TtsSynthesizeErrors]

export type TtsSynthesizeResponses = {
  /**
   * Synthesized speech audio (base64)
   */
  200: {
    audio: string
    format: string
...
export type TtsSynthesizeResponse = TtsSynthesizeResponses[keyof TtsSynthesizeResponses]
