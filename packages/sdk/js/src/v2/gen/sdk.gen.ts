...
import type {
  ...
  DictationTranscribeErrors,
  DictationTranscribeResponses,
...
export class Dictation extends HeyApiClient {
  ...
  public transcribe<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<DictationTranscribeResponses, DictationTranscribeErrors, ThrowOnError>(
      {
        url: "/dictation",
        ...options,
        ...params,
...
export class Tts extends HeyApiClient {
   ...
   * Synthesize speech
   *
   * Convert text to speech with MiMo TTS (model mimo-v2.5-tts) and return the audio as base64.
   */
      ...
      [
        {
          args: [
            ...
            { in: "body", key: "style" },
            { in: "body", key: "mode" },
            { in: "body", key: "designPrompt" },
            { in: "body", key: "referenceAudio" },
            { in: "body", key: "singing" },
            { in: "body", key: "optimizeTextPreview" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<TtsSynthesizeResponses, TtsSynthesizeErrors, ThrowOnError>({
      url: "/tts",
      ...options,
      ...params,
      headers: {
