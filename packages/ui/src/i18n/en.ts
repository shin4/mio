export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subscribe to Mio Go for reliable access to the best open-source models, starting at $5/month.",
  ...
  "ui.message.readAloud.play": "Read aloud",
  "ui.message.readAloud.stop": "Stop reading",
