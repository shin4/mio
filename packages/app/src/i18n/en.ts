export const dict = {
  ...
  "agent.label.build": "Action",
  "agent.label.plan": "Plan",
  ...
  "dialog.provider.mimo.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.mimo.tagline": "Reliable optimized models",
  "dialog.provider.mimoGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MiMo-Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MiMo-Code.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.mimoZen.line1":
    "MiMo-Code Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.mimoZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.mimoZen.visit.prefix": "Visit ",
  "provider.connect.mimoZen.visit.link": "platform.xiaomimimo.com",
  "provider.connect.mimoZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MiMo-Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MiMo-Code.",
  ...
  "provider.mimo.dialog.description": "Configure your connection to the Xiaomi MiMo platform.",
  "provider.mimo.dialog.getKey": "Get an API key →",
  "provider.mimo.billing.label": "Billing",
  "provider.mimo.billing.payAsYouGo.label": "Pay-as-you-go",
  "provider.mimo.billing.payAsYouGo.desc": "USD per-token billing. Best for variable workloads.",
  "provider.mimo.billing.tokenPlan.label": "Token Plan",
  "provider.mimo.billing.tokenPlan.desc": "Subscription with monthly quota. Best for steady usage.",
  "provider.mimo.region.label": "Region",
  "provider.mimo.region.sgp.label": "Singapore (SGP)",
  "provider.mimo.region.sgp.desc": "Default for token-plan users outside China",
  "provider.mimo.region.ams.label": "Amsterdam (AMS)",
  "provider.mimo.region.ams.desc": "Lower latency for European users",
  "provider.mimo.region.cn.label": "China (CN)",
  "provider.mimo.region.cn.desc": "China-mainland endpoint",
  "provider.mimo.apiKey.label": "API Key",
  "provider.mimo.apiKey.show": "Show",
  "provider.mimo.apiKey.hide": "Hide",
  "provider.mimo.apiKey.warning":
    "Expected key starting with \"{{prefix}}\" for {{billing}}. Mismatched keys won't authenticate.",
  "provider.mimo.protocol.label": "API Protocol",
  "provider.mimo.protocol.openai": "OpenAI Compatible",
  "provider.mimo.protocol.anthropic": "Anthropic Compatible",
  "provider.mimo.protocol.openai.hint": "Implicit prefix caching — no setup needed.",
  "provider.mimo.protocol.anthropic.hint": "Explicit cache breakpoints — slightly more aggressive caching.",
  "provider.mimo.model.label": "Default Model",
  "provider.mimo.model.pricing": "(pricing in {{currency}}, per 1M tokens)",
  "provider.mimo.model.in": "in",
  "provider.mimo.model.out": "out",
  "provider.mimo.model.blurb.v25": "1M ctx · Recommended",
  "provider.mimo.model.blurb.v25Pro": "1M ctx · Best for complex tasks",
  "provider.mimo.model.blurb.v2Pro": "256K ctx",
  "provider.mimo.model.blurb.v2Flash": "128K ctx · Cheap & fast",
  "provider.mimo.model.blurb.v2Omni": "128K ctx · Multimodal",
  "provider.mimo.voice.label": "Read-aloud Voice",
  "provider.mimo.voice.default": "Default",
  "provider.mimo.voice.hint": "Voice used when reading assistant replies aloud with MiMo TTS.",
  "provider.mimo.readAloud.error.title": "Couldn't read aloud",
  "provider.mimo.readAloud.error.notConnected": "Connect MiMo in Settings to use read-aloud.",
  "provider.mimo.readAloud.error.failed": "Speech synthesis failed. Please try again.",
  "provider.mimo.readAloud.error.designMissing": "Describe the voice first.",
  "provider.mimo.readAloud.error.cloneMissing": "Choose a reference audio clip first.",
  "provider.mimo.readAloud.error.cloneTooLarge": "Reference audio is too large (max 10MB).",
  "provider.mimo.readAloud.error.cloneType": "Unsupported audio type. Use MP3 or WAV.",
  "provider.mimo.save": "Save Settings",
  "provider.mimo.saving": "Saving…",
  "provider.mimo.disconnecting": "Disconnecting…",

  "onboarding.welcome.title": "Welcome to MiMo",
  "onboarding.welcome.subtitle": "Your coding agent powered by MiMo models.",
  "onboarding.welcome.body": "To get started, connect your MiMo account. You'll need an API key from the MiMo platform.",
  "onboarding.welcome.getKey": "Get API Key",
  "onboarding.welcome.continue": "I already have a key",
  "onboarding.configure.title": "Connect MiMo",
  "onboarding.configure.subtitle": "Enter your API key and preferences to finish setup.",
  ...
  "prompt.dropzone.label": "Drop images, audio, video, PDFs, or text files here",
  ...
  "prompt.dictation.start": "Dictate",
  "prompt.dictation.stop": "Stop dictation",
  "prompt.dictation.transcribing": "Transcribing...",
  "prompt.dictation.unavailable": "Dictation unavailable · Connect MiMo",
  "prompt.dictation.startWithCost": "Dictate with mimo-v2.5-asr · may increase usage cost",
  "prompt.dictation.stopWithCost": "Stop dictation {{time}} · sends audio to mimo-v2.5-asr and may increase usage cost",
  "prompt.dictation.transcribingWithModel": "Transcribing with mimo-v2.5-asr...",
  "prompt.dictation.unavailableWithCost":
    "Dictation unavailable · Connect MiMo. Uses mimo-v2.5-asr and may increase usage cost",
  "prompt.tts.autoplay.on": "Auto read-aloud · on",
  "prompt.tts.autoplay.off": "Auto read-aloud · off",
  "prompt.tts.autoplay.unavailable": "Auto read-aloud · MiMo TTS not configured",

  "prompt.toast.pasteUnsupported.title": "Unsupported attachment",
  "prompt.toast.pasteUnsupported.description": "Only images, audio, video, PDFs, or text files can be attached here.",
  "prompt.toast.attachmentTooLarge.title": "Attachment too large",
  "prompt.toast.attachmentTooLarge.description":
    "{{filename}} encodes to {{size}}, exceeding MiMo's {{limit}} Base64 media limit.",
  "prompt.toast.modelAgentRequired.title": "Select an agent and model",
  "prompt.toast.modelAgentRequired.description": "Choose an agent and model before sending a prompt.",
  "prompt.toast.worktreeCreateFailed.title": "Failed to create worktree",
  "prompt.toast.sessionCreateFailed.title": "Failed to create session",
  "prompt.toast.invalidSessionDirectory.title": "Open a project first",
  "prompt.toast.invalidSessionDirectory.description":
    "New sessions can't be started in your home directory or the filesystem root. Open a project, then try again.",
  "prompt.toast.dictationUnavailable.title": "Connect MiMo first",
  "prompt.toast.dictationUnavailable.description": "Connect MiMo in Settings to use dictation.",
  "prompt.toast.dictationPermission.title": "Microphone unavailable",
  "prompt.toast.dictationPermission.description": "Allow microphone access and try again.",
  "prompt.toast.dictationFailed.title": "Dictation failed",
  "prompt.toast.dictationFailed.description": "Audio transcription failed. Please try again.",
  "prompt.toast.dictationUnsupported.description": "This browser cannot record microphone audio.",
  "prompt.toast.dictationEmpty.description": "No speech was detected.",
  "prompt.toast.dictationRejected.title": "Dictation not sent",
  "prompt.toast.dictationTooShort.description": "The recording is too short. Speak for at least 2 seconds and try again.",
  "prompt.toast.dictationNoSpeech.description": "No clear speech was detected. Move closer to the microphone and try again.",
  ...
  "dialog.plugins.empty": "Plugins configured in mimo.json",
  ...
  "dialog.server.description": "Switch which MiMo-Code server this app connects to.",
  ...
  "toast.update.description": "A new version of MiMo-Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MiMo-Code team",
  ...
  "error.chain.checkConfig": "Check your config (mimo.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MiMo-Code does not support MCP authentication yet.',
  ...
  "session.toolbar.cache.modelBreakdown": "Model breakdown",
  "session.toolbar.cache.moreModels": "+{{count}} more models",
  "session.toolbar.cache.tokens": "{{read}} / {{total}} tokens",
  ...
  "session.toolbar.throughput.tip":
    "TTFT and tok/s only measure the latest turn. Measured locally — the model API reports no server-side timing.",
  "session.toolbar.usage.label": "Usage",
  "session.toolbar.usage.tip": "Cumulative tokens used this session (input + output + cache + reasoning).",
  "session.toolbar.usage.input": "Input",
  "session.toolbar.usage.output": "Output",
  "session.toolbar.usage.reasoning": "Reasoning",
  "session.toolbar.usage.cache": "Cache",
  "session.welcome.title": "How can I help?",
  "session.welcome.subtitle": "Ask me anything about this codebase, or start from a suggestion below.",
  "session.welcome.suggestion.1": "Summarize this codebase",
  "session.welcome.suggestion.2": "Explain this error",
  "session.welcome.suggestion.3": "Why is it drifting?",
  "session.welcome.suggestion.4": "Write a unit test",
  ...
  "sidebar.nav.title": "Sessions",
  "sidebar.toggle.ariaLabel": "Toggle sessions sidebar",
  "sidebar.settings": "Settings",
  "sidebar.help": "Help",
  "sidebar.workspaces.enable": "Enable workspaces",
  "sidebar.workspaces.disable": "Disable workspaces",
  "sidebar.gettingStarted.title": "Getting started",
  "sidebar.gettingStarted.line1": "MiMo-Code includes free models so you can start immediately.",
  ...
  "debugBar.cache.label": "CACHE",
  "debugBar.cache.tip":
    "Prefix-cache hit rate from the latest LLM step. Higher is better; below 70% means the immutable prefix (system prompt + tools) isn't being reused.",
  "debugBar.drift.label": "DRIFT",
  "debugBar.drift.tip":
    "Immutable-prefix drift events observed. Each one means the system prompt or tool list changed mid-session and reset MiMo's prefix cache.",
  ...
  "settings.desktop.wsl.description": "Run the MiMo-Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MiMo-Code",
  ...
  "settings.general.row.appearance.description": "Customise how MiMo-Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MiMo-Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MiMo-Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MiMo-Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MiMo-Code.",
  ...
  "settings.tts.mode.label": "Voice source",
  "settings.tts.mode.preset": "Preset",
  "settings.tts.mode.design": "Voice design",
  "settings.tts.mode.clone": "Voice clone",
  "settings.tts.singing.label": "Singing mode",
  "settings.tts.singing.hint": "Sing the text instead of speaking it (preset voices only).",
  "settings.tts.autoplay.label": "Auto read-aloud",
  "settings.tts.autoplay.hint": "Automatically read each new assistant reply aloud as it finishes.",
  "settings.tts.tags.label": "Audio tags",
  "settings.tts.tags.hint": "Insert tags like （笑）, （叹气）, （紧张，深呼吸） anywhere in the text to control delivery.",
  "settings.tts.design.label": "Voice description",
  "settings.tts.design.hint": "Describe the voice in 1–4 sentences (gender, age, tone, accent, pace, emotion).",
  "settings.tts.design.placeholder": "e.g. A warm, low female voice, speaking slowly and gently.",
  "settings.tts.optimizeTextPreview.label": "Smart text polishing",
  "settings.tts.optimizeTextPreview.hint": "Let mimo-v2.5-tts-voicedesign polish the target read-aloud text.",
  "settings.tts.clone.label": "Reference audio",
  "settings.tts.clone.hint": "Upload an MP3 or WAV clip (≤10MB) to reproduce its timbre.",
  "settings.tts.clone.choose": "Choose file",
  "settings.tts.clone.clear": "Clear",
  "settings.tts.clone.none": "No file selected",
  "settings.tts.clone.selected": "Selected: {{name}}",
  "settings.tts.preview.label": "Preview",
  "settings.tts.preview.play": "Preview",
  "settings.tts.preview.stop": "Stop",
  "settings.tts.preview.sample": "Hello, this is a MiMo voice preview.",
