export const dict = {
  ...
  "dialog.provider.mimo.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.mimo.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.mimoGo.tagline": "Недорога підписка для всіх",
  ...
  "provider.connect.mimoZen.visit.suffix": ", щоб отримати ключ API.",
