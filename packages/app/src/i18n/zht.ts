...
export const dict = {
  ...
  "dialog.provider.mimo.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.mimo.tagline": "可靠的優化模型",
  "dialog.provider.mimoGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "MiMo-Code 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 MiMo-Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.mimoZen.line1": "MiMo-Code Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.mimoZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.mimoZen.visit.prefix": "造訪 ",
  "provider.connect.mimoZen.visit.link": "platform.xiaomimimo.com",
  "provider.connect.mimoZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 MiMo-Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 MiMo-Code 中使用 {{provider}} 模型。",
  ...
  "prompt.dictation.start": "聽寫",
  "prompt.dictation.stop": "停止聽寫",
  "prompt.dictation.transcribing": "正在轉寫...",
  "prompt.dictation.unavailable": "聽寫不可用 · 請先連線 MiMo",
  "prompt.dictation.startWithCost": "聽寫 · 呼叫 mimo-v2.5-asr，可能增加使用成本",
  "prompt.dictation.stopWithCost": "停止聽寫 {{time}} · 停止後呼叫 mimo-v2.5-asr，可能增加使用成本",
  "prompt.dictation.transcribingWithModel": "正在透過 mimo-v2.5-asr 轉寫...",
  "prompt.dictation.unavailableWithCost": "聽寫不可用 · 請先連線 MiMo。功能會呼叫 mimo-v2.5-asr，可能增加使用成本",

  "prompt.toast.pasteUnsupported.title": "不支援的附件",
  "prompt.toast.pasteUnsupported.description": "此處僅能附加圖片、音訊、影片、PDF 或文字檔案。",
  "prompt.toast.attachmentTooLarge.title": "附件過大",
  "prompt.toast.attachmentTooLarge.description": "{{filename}} 編碼後為 {{size}}，超過 MiMo 的 {{limit}} Base64 媒體限制。",
  ...
  "prompt.toast.dictationUnavailable.title": "請先連線 MiMo",
  "prompt.toast.dictationUnavailable.description": "請先在設定中連線 MiMo，再使用聽寫功能。",
  "prompt.toast.dictationPermission.title": "無法使用麥克風",
  "prompt.toast.dictationPermission.description": "請允許麥克風權限後重試。",
  "prompt.toast.dictationFailed.title": "聽寫失敗",
  "prompt.toast.dictationFailed.description": "音訊轉寫失敗，請重試。",
  "prompt.toast.dictationUnsupported.description": "目前瀏覽器無法錄製麥克風音訊。",
  "prompt.toast.dictationEmpty.description": "沒有偵測到語音。",
  "prompt.toast.dictationRejected.title": "未送出聽寫",
  "prompt.toast.dictationTooShort.description": "錄音時間太短，請至少說 2 秒後重試。",
  "prompt.toast.dictationNoSpeech.description": "未偵測到清晰語音，請靠近麥克風後重試。",
  ...
  "dialog.plugins.empty": "在 mimo.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 MiMo-Code 伺服器。",
  ...
  "toast.update.description": "MiMo-Code 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 MiMo-Code 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (mimo.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: MiMo-Code 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "MiMo-Code 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 MiMo-Code 伺服器。",
  ...
  "settings.general.row.language.description": "變更 MiMo-Code 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 MiMo-Code 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 MiMo-Code 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 MiMo-Code 的主題。",
  ...
  "settings.general.row.showFileTree.description": "在桌面工作階段中顯示檔案樹面板",
  "settings.general.row.showNavigation.title": "導覽控制項",
  "settings.general.row.showNavigation.description": "在桌面標題列中顯示返回和前進按鈕",
  "settings.general.row.showSearch.title": "命令面板",
  "settings.general.row.showSearch.description": "在桌面標題列中顯示搜尋和命令面板按鈕",
  ...
  "settings.general.row.showStatus.description": "在桌面標題列中顯示伺服器狀態按鈕",
  "settings.general.row.showCustomAgents.title": "自訂代理程式",
  "settings.general.row.showCustomAgents.description": "在 v2 桌面輸入框中顯示代理程式選擇器",
  ...
  "settings.general.row.pinchZoom.description": "允許觸控板雙指和 Ctrl+滾輪手勢進行縮放",
  ...
  "settings.updates.row.startup.description": "在 MiMo-Code 啟動時自動檢查更新",
  ...
  "settings.tts.optimizeTextPreview.label": "智慧潤飾",
  "settings.tts.optimizeTextPreview.hint": "讓 mimo-v2.5-tts-voicedesign 自動潤飾目標播報文字。",
