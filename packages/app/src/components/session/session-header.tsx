...
export function SessionHeader() {
  ...
  // v1 cleanup: newLayoutDesigns is always true; isDesktopV2 collapses to
  // platform === "desktop". The show* settings are real user toggles in v2.
  const isDesktopV2 = createMemo(() => platform.platform === "desktop")
