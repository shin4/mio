...
// MiMo audio understanding accepts MP3/WAV/FLAC/M4A/OGG. These are the
// canonical browser-reported MIMEs (audio/mpeg = mp3, audio/mp4 = m4a).
export const ACCEPTED_AUDIO_TYPES = ["audio/mpeg", "audio/wav", "audio/flac", "audio/mp4", "audio/ogg"]
