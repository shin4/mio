...
import { isForcedVisibleModel } from "@/context/models"
...
export const DialogManageModels: Component = () => {
  ...
  const providerLocked = (providerID: string) =>
    providerList(providerID).every((x) => isForcedVisibleModel({ modelID: x.id, providerID: x.provider.id }))
    ...
    >
      <List
            ...
            <>
              ...
              >
                <Switch
                  ...
                  disabled={providerLocked(provider.id)}
        ...
        onSelect={(x) => {
          ...
          if (isForcedVisibleModel(key)) return
          ...
          <div class="w-full flex items-center justify-between gap-x-3">
            ...
            <div onClick={(e) => e.stopPropagation()}>
              <Switch
                ...
                disabled={isForcedVisibleModel({ modelID: i.id, providerID: i.provider.id })}
                onChange={(checked) => {
