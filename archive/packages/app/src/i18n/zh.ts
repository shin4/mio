...
export const dict = {
  ...
  "dialog.provider.mimo.note": "使用 Mio Zen 或 API 密钥连接",
  "dialog.provider.mimo.tagline": "可靠的优化模型",
  "dialog.provider.mimoGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Mio 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Mio 中使用 {{provider}} 模型。",
  ...
  "provider.connect.mimoZen.line1": "Mio Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.mimoZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.mimoZen.visit.prefix": "访问 ",
  "provider.connect.mimoZen.visit.link": "platform.xiaomimimo.com",
  "provider.connect.mimoZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Mio 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Mio 中使用 {{provider}} 模型。",
  ...
  "provider.mimo.dialog.description": "配置您与小米 MiMo 平台的连接。",
  "provider.mimo.dialog.getKey": "获取 API Key →",
  "provider.mimo.billing.label": "计费方式",
  "provider.mimo.billing.payAsYouGo.label": "按量计费",
  "provider.mimo.billing.payAsYouGo.desc": "按 token 美元计费，适合波动负载。",
  "provider.mimo.billing.tokenPlan.label": "套餐",
  "provider.mimo.billing.tokenPlan.desc": "月度配额订阅，适合稳定用量。",
  "provider.mimo.region.label": "区域",
  "provider.mimo.region.sgp.label": "新加坡 (SGP)",
  "provider.mimo.region.sgp.desc": "中国大陆以外套餐用户的默认选择",
  "provider.mimo.region.ams.label": "阿姆斯特丹 (AMS)",
  "provider.mimo.region.ams.desc": "欧洲用户延迟更低",
  "provider.mimo.region.cn.label": "中国 (CN)",
  "provider.mimo.region.cn.desc": "中国大陆接入点",
  "provider.mimo.apiKey.label": "API Key",
  "provider.mimo.apiKey.show": "显示",
  "provider.mimo.apiKey.hide": "隐藏",
  "provider.mimo.apiKey.warning": "{{billing}} 期望以 “{{prefix}}” 开头的密钥，不匹配的密钥将无法认证。",
  "provider.mimo.protocol.label": "API 协议",
  "provider.mimo.protocol.openai": "OpenAI 兼容",
  "provider.mimo.protocol.anthropic": "Anthropic 兼容",
  "provider.mimo.protocol.openai.hint": "隐式前缀缓存 —— 无需任何配置。",
  "provider.mimo.protocol.anthropic.hint": "显式缓存断点 —— 缓存策略稍微更激进。",
  "provider.mimo.model.label": "默认模型",
  "provider.mimo.model.pricing": "（计价币种 {{currency}}，每 100 万 tokens）",
  "provider.mimo.model.in": "输入",
  "provider.mimo.model.out": "输出",
  "provider.mimo.model.blurb.v25": "1M 上下文 · 推荐",
  "provider.mimo.model.blurb.v25Pro": "1M 上下文 · 适合复杂任务",
  "provider.mimo.model.blurb.v2Pro": "256K 上下文",
  "provider.mimo.model.blurb.v2Flash": "128K 上下文 · 便宜快速",
  "provider.mimo.model.blurb.v2Omni": "128K 上下文 · 多模态",
  "provider.mimo.voice.label": "朗读音色",
  "provider.mimo.voice.default": "默认",
  "provider.mimo.voice.hint": "使用 MiMo TTS 朗读助手回复时所用的音色。",
  "provider.mimo.readAloud.error.title": "无法朗读",
  "provider.mimo.readAloud.error.notConnected": "请先在设置中连接 MiMo，再使用朗读功能。",
  "provider.mimo.readAloud.error.failed": "语音合成失败，请重试。",
  "provider.mimo.readAloud.error.designMissing": "请先描述想要的音色。",
  "provider.mimo.readAloud.error.cloneMissing": "请先选择参考音频。",
  "provider.mimo.readAloud.error.cloneTooLarge": "参考音频过大（最大 10MB）。",
  "provider.mimo.readAloud.error.cloneType": "不支持的音频格式，请使用 MP3 或 WAV。",
  "provider.mimo.save": "保存设置",
  "provider.mimo.saving": "保存中…",
  "provider.mimo.disconnecting": "断开中…",

  "onboarding.welcome.title": "欢迎使用 MiMo",
  "onboarding.welcome.subtitle": "由 MiMo 模型驱动的编程助手。",
  "onboarding.welcome.body": "开始之前，请连接您的 MiMo 账户。您需要在 MiMo 平台获取一个 API Key。",
  "onboarding.welcome.getKey": "获取 API Key",
  "onboarding.welcome.continue": "我已有 API Key",
  "onboarding.configure.title": "连接 MiMo",
  "onboarding.configure.subtitle": "输入您的 API Key 和偏好设置以完成配置。",
  "onboarding.back": "返回",
  ...
  "prompt.placeholder.design": "随心输入，/ 调用命令，@ 引用上下文…",
  ...
  "prompt.dictation.start": "听写",
  "prompt.dictation.stop": "停止听写",
  "prompt.dictation.transcribing": "正在转写...",
  "prompt.dictation.unavailable": "听写不可用 · 请先连接 MiMo",
  "prompt.dictation.startWithCost": "听写 · 调用 mimo-v2.5-asr，可能增加使用成本",
  "prompt.dictation.stopWithCost": "停止听写 {{time}} · 停止后调用 mimo-v2.5-asr，可能增加使用成本",
  "prompt.dictation.transcribingWithModel": "正在通过 mimo-v2.5-asr 转写...",
  "prompt.dictation.unavailableWithCost": "听写不可用 · 请先连接 MiMo。功能会调用 mimo-v2.5-asr，可能增加使用成本",
  "prompt.tts.autoplay.on": "自动朗读 · 开",
  "prompt.tts.autoplay.off": "自动朗读 · 关",
  "prompt.tts.autoplay.unavailable": "自动朗读 · 未配置 MiMo TTS",
  "prompt.toast.pasteUnsupported.title": "不支持的附件",
  "prompt.toast.pasteUnsupported.description": "此处仅能附加图片、音频、视频、PDF 或文本文件。",
  "prompt.toast.attachmentTooLarge.title": "附件过大",
  "prompt.toast.attachmentTooLarge.description": "{{filename}} 编码后为 {{size}}，超过 MiMo 的 {{limit}} Base64 媒体限制。",
  ...
  "prompt.toast.invalidSessionDirectory.title": "请先打开一个项目",
  "prompt.toast.invalidSessionDirectory.description": "无法在主目录或文件系统根目录下新建会话。请先打开一个项目，然后重试。",
  "prompt.toast.dictationUnavailable.title": "请先连接 MiMo",
  "prompt.toast.dictationUnavailable.description": "请先在设置中连接 MiMo，再使用听写功能。",
  "prompt.toast.dictationPermission.title": "无法使用麦克风",
  "prompt.toast.dictationPermission.description": "请允许麦克风权限后重试。",
  "prompt.toast.dictationFailed.title": "听写失败",
  "prompt.toast.dictationFailed.description": "音频转写失败，请重试。",
  "prompt.toast.dictationUnsupported.description": "当前浏览器无法录制麦克风音频。",
  "prompt.toast.dictationEmpty.description": "没有检测到语音。",
  "prompt.toast.dictationRejected.title": "未发送听写",
  "prompt.toast.dictationTooShort.description": "录音时间太短，请至少说 2 秒后重试。",
  "prompt.toast.dictationNoSpeech.description": "未检测到清晰语音，请靠近麦克风后重试。",
  ...
  "dialog.plugins.empty": "在 mio.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Mio 服务器。",
  ...
  "context.breakdown.messages": "消息历史",
  "context.capsule.window": "上下文窗口",
  "context.capsule.note": "实时总量 · 估算构成",
  "context.capsule.approx": "约",
  "context.capsule.empty": "暂无用量",
  ...
  "toast.update.description": "Mio 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Mio 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (mio.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Mio 暂不支持 MCP 认证。',
  ...
  "session.toolbar.cache.modelBreakdown": "模型拆分",
  "session.toolbar.cache.moreModels": "另有 {{count}} 个模型",
  ...
  "session.toolbar.throughput.tip": "首字延迟和 tok/s 仅统计最近一轮。本地测量——模型 API 不返回服务端时延。",
  "session.toolbar.usage.label": "用量",
  "session.toolbar.usage.tip": "本次会话累计 Token（输入 + 输出 + 缓存 + 推理）。",
  "session.toolbar.usage.input": "输入",
  "session.toolbar.usage.output": "输出",
  "session.toolbar.usage.reasoning": "推理",
  "session.toolbar.usage.cache": "缓存",
  "session.welcome.title": "有什么可以帮你?",
  "session.welcome.subtitle": "问我关于这个代码库的任何问题,或从下面开始。",
  "session.welcome.suggestion.1": "帮我总结这个代码库",
  "session.welcome.suggestion.2": "解释一下这段报错",
  "session.welcome.suggestion.3": "为什么会漂移",
  "session.welcome.suggestion.4": "写一个单元测试",
  ...
  "status.popover.tab.context": "上下文",
  ...
  "sidebar.nav.title": "会话",
  "sidebar.toggle.ariaLabel": "切换会话侧边栏",
  "sidebar.settings": "设置",
  "sidebar.help": "帮助",
  "sidebar.workspaces.enable": "启用工作区",
  "sidebar.workspaces.disable": "禁用工作区",
  "sidebar.gettingStarted.title": "入门",
  "sidebar.gettingStarted.line1": "Mio 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Mio 服务器。",
  ...
  "settings.general.row.language.description": "更改 Mio 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Mio 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Mio 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Mio 的主题。",
  ...
  "settings.general.row.showFileTree.description": "在桌面会话中显示文件树面板",
  ...
  "settings.general.row.showCustomAgents.description": "在 v2 桌面输入框中显示智能体选择器",
  ...
  "settings.updates.row.startup.description": "在 Mio 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Mio。",
  ...
  "settings.tts.mode.label": "音色来源",
  "settings.tts.mode.preset": "预置音色",
  "settings.tts.mode.design": "音色设计",
  "settings.tts.mode.clone": "音色复刻",
  "settings.tts.singing.label": "唱歌模式",
  "settings.tts.singing.hint": "让模型演唱文本而非朗读（仅支持预置音色）。",
  "settings.tts.autoplay.label": "自动朗读",
  "settings.tts.autoplay.hint": "每条新的助手回复生成完成后自动朗读。",
  "settings.tts.tags.label": "音频标签",
  "settings.tts.tags.hint": "在文本任意位置插入 （笑）、（叹气）、（紧张，深呼吸） 等标签来控制演绎效果。",
  "settings.tts.design.label": "音色描述",
  "settings.tts.design.hint": "用 1–4 句话描述想要的音色（性别、年龄、语气、口音、语速、情绪）。",
  "settings.tts.design.placeholder": "例如：一个温暖低沉的女声，语速缓慢而温柔。",
  "settings.tts.optimizeTextPreview.label": "智能润色",
  "settings.tts.optimizeTextPreview.hint": "让 mimo-v2.5-tts-voicedesign 自动润色目标播报文本。",
  "settings.tts.clone.label": "参考音频",
  "settings.tts.clone.hint": "上传一段 MP3 或 WAV 音频（≤10MB）以复刻其音色。",
  "settings.tts.clone.choose": "选择文件",
  "settings.tts.clone.clear": "清除",
  "settings.tts.clone.none": "未选择文件",
  "settings.tts.clone.selected": "已选择：{{name}}",
  "settings.tts.preview.label": "试听",
  "settings.tts.preview.play": "试听",
  "settings.tts.preview.stop": "停止",
  "settings.tts.preview.sample": "你好，这是一段 MiMo 语音试听。",
  ...
  "debugBar.cache.tip": "最近一次 LLM 调用的前缀缓存命中率。越高越好;低于 70% 说明不可变前缀(系统提示 + 工具)没有被复用。",
  "debugBar.drift.label": "DRIFT",
  "debugBar.drift.tip": "已观测到的不可变前缀漂移次数。每发生一次,说明系统提示或工具列表中途改变,导致 MiMo 前缀缓存被重置。",
