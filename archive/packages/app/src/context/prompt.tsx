...
export interface VideoAttachmentPart {
  type: "video"
  id: string
  filename: string
  mime: string
...
export type MediaAttachmentPart = ImageAttachmentPart | AudioAttachmentPart | VideoAttachmentPart | PdfAttachmentPart
...
function isPartEqual(partA: ContentPart, partB: ContentPart) {
  switch (partA.type) {
    ...
    case "video":
    case "pdf":
      return partB.type === partA.type && partA.id === partB.id
  }
}
