...
export function agentDisplayLabel(name: string, t: (key: "agent.label.build" | "agent.label.plan") => string) {
  if (name === "build") return t("agent.label.build")
  if (name === "plan") return t("agent.label.plan")
  return name
}
