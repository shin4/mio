...
import { dictationHandlers } from "./handlers/dictation"
...
// Provides the WorkspaceRoutingMiddleware (declared by route groups via
// `.middleware(WorkspaceRoutingMiddleware)`). Pulls the optional `directory`
// query string into the request scope.
const workspaceRoutingLive = workspaceRoutingLayer
...
export function createRoutes(
  ...
  ) as unknown) as Layer.Layer<never, EffectConfig.ConfigError, RouteRequirements>
}
