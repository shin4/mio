...
export function webSearchEnabled(_providerID: ProviderID, flags = { exa: false, parallel: false }) {
  // mimo-desktop no longer routes through the opencode provider, so web-search
  // gating is now controlled by feature flags only.
