...
export const SessionTable = sqliteTable(
  "session",
  {
    ...
    // Three-region context: hash of (system segments + sorted tool names) locked on first request.
    // Any change to this hash between turns means the immutable prefix drifted and cache was lost.
    immutable_hash: text(),
