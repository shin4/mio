export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Mio Desktop",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Mio Desktop، هل ترغب في تثبيته وإعادة تشغيله؟",
