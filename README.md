...
The intro voice on the **[landing page](https://shin4.github.io/mimo-code/#capabilities)** was generated by MiMo-Code's own built-in TTS — the product demonstrating its own multimodal pipeline, not a recorded voiceover. **[▶ Listen →](https://shin4.github.io/mimo-code/#capabilities)** · English voice *Chloe*, Chinese voice *冰糖*.

<details>
<summary>Transcript</summary>

> "The voice you're hearing right now was generated by MiMo-Code itself. It's a free, open-source desktop coding agent for the MiMo models — it reasons over your screenshots, PDFs and video, takes your prompts by voice, and reads its answers back. Built for Windows and macOS."
